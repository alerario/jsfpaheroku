...
public class JSFHerokuBDSetup {
    ...
    public void configurar() {
        ...
        if (databaseUrl != null) {
            ...
            properties.replace("javax.persistence.jdbc.url", jdbcUrl);
            ...
            String dbVendor = "jdbc:postgresql://localhost:5432/cfdb";
            String userName = "postgres";
            String password = "postgres";
             host = "localhost";
            String port = "5432";
            String databaseName = "cfdb";
            String jdbcUrl = "jdbc:postgresql://localhost:5432/cfdb";
            this.conf = jdbcUrl;
            Map<String, String> properties = new HashMap<String, String>();
        ...
        //removido do arquivo persistence.xml
